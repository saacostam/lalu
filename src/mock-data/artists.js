export const ARTISTS = [
    {
        ...
        description: 'Fred describes his music as ‘Actual Life’, a trademark sound that features vocals uncovered from the unlikeliest of sources; from obscure YouTube clips to personal FaceTime conversations, random Instagram accounts and iPhone video footage of half-remembered nights out. The end results – often made on the move wherever Fred has his laptop – shift between dancefloor-inspired euphoria and yearning melancholy and you’ll hear the likes of The Blessed Madonna, Mr Eazi and Headie One among lesser known voices.'
    },
    {
        id: 1,
        name: 'CamelPhat',
        imgSrc: 'https://github.com/saacostam/lalu_fe/raw/master/public/images/artists/camelphat.jpg',
        description: 'Grammy Nominated, Ivor Novello Nominated, Triple platinum selling Artists.'
    },
    {
        id: 2,
        name: 'Sasha Alex Sloan',
        imgSrc: 'https://github.com/saacostam/lalu_fe/raw/master/public/images/artists/sasha_alex_sloan.jpg',
        description: 'life is a scam<3',
    },
    {
        id: 3,
        name: 'Sandro Cavazza',
        imgSrc: 'https://github.com/saacostam/lalu_fe/raw/master/public/images/artists/sandro_cavazza.jpg',
        description: `Hailing from Sweden, Sandro Cavazza is a pop singer and songwriter who has made a name for himself collaborating with some of the biggest names in the electronic music scene. His songs & collaborations with Avicii, Kygo, and Lost Frequencies have garnered over 4 billion streams, making him a force to be reckoned with.`,
    },
    {
        id: 4,
        name: 'The Beatles',
